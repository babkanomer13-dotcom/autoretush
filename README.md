...
Сейчас реализуется этап 0: безопасная инвентаризация архива и подготовка строго совпадающих кадров. Это критично: разные фотографии одного человека не являются корректной supervised-парой и разрушают пиксельные функции потерь.
